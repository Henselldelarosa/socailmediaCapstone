...
def seed_replies():
    ...
    reply3 = Reply( reply='Yes it was', replyUrl='', userId=3, postId=2)
    reply4 = Reply( reply='Chest day?', replyUrl='', userId=3, postId=2)
    reply5 = Reply( reply='My day been good', replyUrl='',  userId=1, postId=3)
    reply6 = Reply( reply='That helps', replyUrl='', userId=1, postId=4)
